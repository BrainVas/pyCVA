...
class RegionSegmentor:
    def __init__(self):
        ...
        model_path = os.path.join(MODELS_DIR, "segmentation_model.pth")
        downloadIfNeeded.download("https://zenodo.org/records/15635651/files/segmentation_model.pth?download=1", model_path)
