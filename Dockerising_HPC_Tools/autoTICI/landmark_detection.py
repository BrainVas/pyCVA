...
ZENODO_URLS = {
    "ap": "https://zenodo.org/records/15635651/files/ap_combined.h5?download=1",
    "lateral": "https://zenodo.org/records/15635651/files/lateral_combined.h5?download=1"
}
...
class LandmarkDetector:
    def __init__(self, view):
        ...
        model_filename = f"{view}_combined.h5"
        model_path = os.path.join(MODELS_DIR, model_filename)

        downloadIfNeeded.download(ZENODO_URLS[view], model_path)
